  ...
  return (
    <div className="text-center mb-12">
      <div className="inline-flex items-center px-4 py-2 bg-blue-100 text-blue-800 rounded-full text-sm font-medium mb-6">
        ...
        19 Retinal Conditions • Real-Time Analysis
      </div>
      
      <h2 className="text-5xl font-bold text-gray-900 mb-6 leading-tight">
        Revolutionizing Eye Care with<br />
      ...
      <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
        Experience the future of retinal screening with our cutting-edge neural network. 
        Simply upload a fundus image and receive instant, comprehensive analysis across 19 critical eye conditions 
        with clinical-grade accuracy and detailed diagnostic insights.
      </p>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto mb-12">
        ...
        <div className="bg-white/60 backdrop-blur-sm rounded-xl p-6 border border-white/20">
          ...
          <div className="text-sm text-gray-600">Medical Images</div>
        </div>
